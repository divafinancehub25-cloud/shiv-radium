...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-11 z-50 w-80 rounded-2xl border border-white/[0.08] bg-[#111]/95 backdrop-blur-xl shadow-2xl overflow-hidden">
          {/* Header */}
            ...
            {loading ? (
              ...
              items.slice(0, 8).map((n) => (
                <div
                  ...
                  className={`flex gap-3 px-4 py-3 border-b border-white/[0.04] last:border-0 cursor-pointer transition-colors hover:bg-white/[0.03] ${!n.isRead ? "bg-[#D4AF37]/[0.03]" : ""}`}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-white/30 mt-0.5 leading-snug line-clamp-2">{n.message}</p>
