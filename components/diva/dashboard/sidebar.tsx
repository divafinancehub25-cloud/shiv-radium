...
import {
  ...
  Download, Layers, Users, Trophy, Megaphone, Star, Bell,
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { section: "Community" },
  { href: "/diva-app/referrals",    label: "Referrals",        icon: Users },
  { href: "/diva-app/leaderboard",  label: "Leaderboard",      icon: Trophy },
  { href: "/diva-app/achievements", label: "Achievements",     icon: Star },
  { href: "/diva-app/community",    label: "Community Center", icon: Megaphone },
  { section: "Account" },
  { href: "/diva-app/notifications",          label: "Notifications",    icon: Bell },
  ...
  return (
    <aside className="flex h-screen sticky top-0 w-64 flex-col border-r border-white/[0.05] bg-black/40 backdrop-blur-xl overflow-y-auto">
      ...
      <div className="flex items-center gap-3 border-b border-white/[0.05] px-6 py-5 flex-shrink-0">
        ...
        <div>
          <p className="text-sm font-bold text-white">STICKO</p>
