...
export async function adminApproveKYC(kycId: string, adminId: string) {
  ...
  await createNotification({ userId: kyc.userId, title: "KYC Approved ✅", message: "Your identity verification has been approved. Your account is now fully active!", type: "kyc", link: "/diva-app/kyc" });
