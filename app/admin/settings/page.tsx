    ...
    <div className="p-6">
      ...
      <div className="space-y-6 max-w-2xl">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          ...
          <p className="text-xs text-gray-400 mb-4">Keys .env file mein set karo</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          ...
          <p className="text-xs text-gray-400 mt-3">In-code change karna hai abhi — aage se editable hoga</p>
        </div>
      </div>
    </div>
  );
